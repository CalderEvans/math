...
\[
\begin{aligned}
    &={\int_{-2}^{2}} \hspace{2mm} 9-y^2 - (y^2+1) \hspace{2mm} dy \\
    &={\int_{-2}^{2}} \hspace{2mm} 9-y^2 - y^2-1 \hspace{2mm} dy\\
    &={\int_{-2}^{2}} \hspace{2mm} -2y^2+8 \hspace{2mm} dy \\
    &=(-\frac{2}{3}y^3+8y)|_{-2}^{2} \\
    &=(-\frac{2}{3}(2)^3+8(2))) - (-\frac{2}{3}(-2)^3+8(-2)) \\
    &=(-\frac{2}{3}(8)+16)) - (-\frac{2}{3}(-8)-16) \\
    &=(-\frac{16}{3}+16)) - (\frac{16}{3}-16) \\
    &=-\frac{16}{3}+16 - \frac{16}{3}+16 \\
    &=2(-\frac{16}{3}+16) \\
    &=2(-\frac{16}{3}+\frac{48}{3}) \\
    &=2(\frac{32}{3}) \\
    &=\frac{64}{3}
\end{aligned}
\]