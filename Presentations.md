...
<details>
  <summary> View Presentation </summary>
  <p>
    <iframe src="{{ site.baseurl }}/files/TopologyFinalProject.pdf" width="100%" height="600px" style="border: inset;"> </iframe>
  </p>
</details>
<div style="margin-top: 30px;"></div>
...
<details>
  <summary> View Presentation </summary>
  <p>
    <iframe src="{{ site.baseurl }}/files/GraphingMerminPeres.pdf" width="100%" height="600px" style="border: inset;"> </iframe>
  </p>
</details>
...
<details>
  <summary> View Presentation </summary>
  <p>
    <iframe src="{{ site.baseurl }}/files/MAT_486H_Graceful_Labeling_Slides.pdf" width="100%" height="600px" style="border: inset;"> </iframe>
  </p>
</details>